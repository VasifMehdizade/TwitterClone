...
class EntryController: BaseVC {
    ...
    lazy var createAccountButton: CustomButton = {
        let button = CustomButton(backgroundcolor: .white,
                                  ...
                                  titleColor: .black,
                                  size: 20, cornerRadius: 30)
        button.addTarget(self, action: #selector(tappedGoRegister), for: .touchUpInside)
    ...
    override func setupView() {
        ...
        viewModel.coordinator = AppCoordinator(navigationController: nav)
    ...
    override func setupAnchors() {
        ...
        iconView.anchor(top: view.safeAreaLayoutGuide.topAnchor,
                        padding: .init(top: 12),
                        size: .init(width: 20, height: 20))
        
        infoLabel.anchor(top: view.topAnchor,
                         leading: view.leadingAnchor,
                         trailing: view.trailingAnchor,
                         padding: .init(top: 180, leading: 30, trailing: -30),
        ...
        stackView.anchor(leading: infoLabel.leadingAnchor,
                         trailing: infoLabel.trailingAnchor,
                         padding: .init(bottom: 0),
                         size: .init(width: 0, height: 128))
        
        buttonStackView.anchor(leading: infoLabel.leadingAnchor,
                               bottom: textView.topAnchor,
                               trailing: infoLabel.trailingAnchor,
                               padding: .init(bottom: -12),
                               size: .init(width: 0, height: 210))
        
        textView.anchor(leading: infoLabel.leadingAnchor,
                        bottom: haveAnAccountAlreadyLabel.topAnchor,
                        trailing: stackView.trailingAnchor,
                        padding: .init(top:12, leading: 0, bottom: -60, trailing: -0),
                        size: .init(width: 0, height: 40))
        
        haveAnAccountAlreadyLabel.anchor(leading: infoLabel.leadingAnchor,
                                         bottom: view.bottomAnchor,
                                         padding: .init(leading: 12, bottom: -50, trailing: -0),
                                         size: .init(width: 200, height: 20))
        
        loginButton.anchor(top: haveAnAccountAlreadyLabel.topAnchor,
                           leading: haveAnAccountAlreadyLabel.trailingAnchor,
                           bottom: haveAnAccountAlreadyLabel.bottomAnchor,
